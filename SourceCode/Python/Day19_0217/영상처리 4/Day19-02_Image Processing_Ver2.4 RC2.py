# Day19-02_Image Processing_Ver2.4 RC2.py (Color Image Processing with OpenCV)
...
# *************************** < 메인 함수 > ***************************
window = Tk()
window.title(" GrayScale Image Processing Ver2.4 RC 2 ")
...
Turn.add_cascade(label='2. 자유 회전 (입력)', menu=Turn_Free)
...
openCVMenu.add_command(label='동일 영상', command=cvEqualImage)
openCVMenu.add_command(label='HSV 변환', command=cvHSVImage)
openCVMenu.add_command(label='엠보싱', command=cvEmbossImage)
openCVMenu.add_command(label='카툰이미지', command=cvCartoonImage)
openCVMenu.add_command(label='색상 추출', command=cvMyColorImage)
