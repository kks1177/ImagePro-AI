...
void turnFree(int val);						// K.자유회전_시계방향 (포워딩)
void turnFreeCenter(int val);				// K.자유회전_시계방향 (백워딩+중앙회전)
void revTurnFree(int val);					// K.자유회전_반시계방향 (포워딩)
void revTurnFreeCenter(int val);		// K.자유회전_반시계방향 (백워딩+중앙회전)
