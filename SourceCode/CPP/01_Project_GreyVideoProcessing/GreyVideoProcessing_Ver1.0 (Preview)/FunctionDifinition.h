...
void printMenu() {
	puts("\n");
	puts("\t\t\t      ===========================================================================");
	puts("\t\t\t                     ### GreyScale Video Processing Ver 1.0 (Preview 1) ###\n");
	puts("\t\t\t      ---------------------------------------------------------------------------");
	puts("\t\t\t\t [ 파일 메뉴 선택 ] \t 1.열기  2.저장  0.종료 \n\n");

	puts("\t\t\t\t [ 1.화소점 처리 기능 메뉴 선택 ] ");
	puts("\t\t\t\t     A.밝기  B.선명도  C.반전  D.흑백  E.비트연산 ");
	puts("\t\t\t\t     F.감마변환  G.범위강조  H.파라볼라 변환  I.스트래칭 \n");

	puts("\t\t\t\t [ 2.히스토그램 처리 기능 메뉴 선택 ] ");
	puts("\t\t\t\t     N.스트래칭  O.엔드-인 탐색  P.평활화 \n");

	puts("\t\t\t\t [ 3.화소영역 처리 기능 메뉴 선택 ] ");
	puts("\t\t\t\t	 Q.엠보싱  R.블러링  S.,,,  T.,,,  U.,,, \n");

	puts("\t\t\t\t [ 4.기하학 처리 기능 메뉴 선택 ] ");
	puts("\t\t\t\t     J.미러링  K.회전  L.확대/축소  M.이동 \n");
	puts("\t\t\t      =========================================================================== \n");
